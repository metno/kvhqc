...
#define mi_foreach(a, b) for(a : b)
#define mi_foreach_r(a, b) for(a : b)
#error "mi_foreach_r is defined wrongly for the cdt parser"
#else
...
#define mi_foreach(a, b)   GCC_FOREACH_BASE(a, b, false)
#define mi_foreach_r(a, b) GCC_FOREACH_BASE(a, b, true)
