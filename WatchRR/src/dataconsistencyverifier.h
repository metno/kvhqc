...
*/
#ifndef __WatchRR__DataConsistencyVerifier_h__
#define __WatchRR__DataConsistencyVerifier_h__
...
namespace WatchRR
{
  ...
  public:
    ...
    typedef std::list<kvalobs::kvData> DataList;
   	...
   	virtual ~DataConsistencyVerifier() {}
...
#endif // __WatchRR__DataConsistencyVerifier_h__
