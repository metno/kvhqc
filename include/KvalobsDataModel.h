...
{ Q_OBJECT;
public:
    KvalobsDataModel(const std::vector<int> & parameters, KvalobsDataListPtr datalist,
...
private:
    ...
    bool mShowStationNameInHeader;
    bool mShowPositionInHeader;
    bool mShowHeightInHeader;
    bool mShowTypeIdInHeader;

    bool mCorrectedValuesAreEditable;
