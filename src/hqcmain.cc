  ...
  , datalist(new model::KvalobsDataList)
{
  ...
  poID = choice->addAction( "Vis &lengde, bredde, h�yde", this, SLOT(showPos()));
...
//  choice->setItemChecked(orID, isShOr);
  ...
  showmenu->addAction( "&Nedb�r", this, SLOT( showWatchRR() ), Qt::CTRL+Qt::Key_R );
  showmenu->addAction( "&V�r", this, SLOT( showWeather() ), Qt::CTRL+Qt::Key_V );
  showmenu->insertSeparator();
  ...
  menuBar()->insertItem( "V�r&element", weathermenu);
  wElement = "";
  ...
  prID = weathermenu->addAction( "&Nedb�r og sn�forhold",    this, SLOT(precipitation()) );
